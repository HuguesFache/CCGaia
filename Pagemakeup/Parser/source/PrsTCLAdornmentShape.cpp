			...
			GraphicsData* gd, int32 flags)
{
	do {
		...
		// Bumped 10pt → 13pt for readability (the older size was hard to
		// read at 100% zoom). Padding bumped along with the font so the box
		// keeps a sensible margin around the text.
		PMReal fontSize = 13.0;
